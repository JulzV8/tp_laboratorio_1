...
/** \brief filtra la lista segun una funcion criterio
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
...
/** \brief realiza la misma funcion en todo el array
 * \param pList LinkedList* Puntero a la lista
...
/** \brief realiza la misma funcion en todo el array con un criterio int mientras que cuenta los resultados
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
int ll_mapContadorPorId(LinkedList* this,int id, int (*pFunc)(void*,int), int* result)
{
	int retorno=-1;
	int contador=0;
	void* pElement;
	...
	if(this!=NULL && pFunc!=NULL)
	{
		...
		{
			pElement=ll_get(this,i);
			contador = contador + pFunc(pElement,id);
			retorno=0;
		}
		*result=contador;
	}
...
/** \brief realiza la misma funcion en el array hasta que uno de resultado 0
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
int ll_mapBreak(LinkedList* this, int (*pFunc)(void*))
{
	int retorno=-1;
	void* pElement;
	int size = ll_len(this);
